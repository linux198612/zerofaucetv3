...
('1', 'faucet_name', 'ZeroFaucet Script'),
...
('36', 'autofaucet_status', 'off'),
('37', 'banner_header_withdraw', ''),
('38', 'offerwalls_status', 'off'),
('39', 'bitcotasks_status', 'off'),
('40', 'bitcotasks_api', ''),
('41', 'bitcotasks_secret', ''),
('42', 'bitcotasks_bearer_token', ''),
('43', 'bitcotasks_ptc_status', 'off'),
('44', 'bitcotasks_shortlinks_status', 'off'),
